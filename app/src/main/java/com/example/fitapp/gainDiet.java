...
public class gainDiet extends AppCompatActivity {
    TabLayout tabLayout;
    ViewPager2 pager2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gain_diet);

        createNotificationChannel();

        Intent intent8 = new Intent(gainDiet.this,ReminderBroadcast.class);
        PendingIntent pendingIntent = PendingIntent.getBroadcast(gainDiet.this,0,intent8,PendingIntent.FLAG_IMMUTABLE);
